 ...
 * @public
 */
Client.prototype.taobao_jindoucloud_message_send = function (params, callback) {
  var err = checkRequired(params, ['messages']);
  if (err) {
    return callback(err);
  }
  this.invoke('taobao_jindoucloud_message_send', params,
    ['jindoucloud_message_send_response', 'send_results', 'message_send_result'], null, 'GET', callback);
};
