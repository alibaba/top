...
Client.prototype.tmall_selected_items_search = function (params, callback) {
  ...
  that.request(params, function (err, result) {
    ...
    var tmall_selected_items_search_response = result.tmall_selected_items_search_response;
    var items = [];
    if (tmall_selected_items_search_response && tmall_selected_items_search_response.item_list && tmall_selected_items_search_response.item_list.selected_item) {
      items = tmall_selected_items_search_response.item_list.selected_item;
    }
    callback(null, items);
  });
};
...
Client.prototype.taobao_item_get = function (params, callback) {
  ...
  that.request(params, function (err, result) {
    ...
    var item_get_response = result.item_get_response;
    var item = item_get_response && item_get_response.item || {};
    callback(null, item);
  });
};
...
Client.prototype.taobao_shop_get = function (params, callback) {
  ...
  that.request(params, function (err, result) {
    ...
    var response = result.shop_get_response;
    var item = response && response.shop || null;
    callback(null, item);
  });
};
